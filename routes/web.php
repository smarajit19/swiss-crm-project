...
Route::get('/total-heat-pro/checkout-now-v3', [CheckoutController::class, 'index']);

Route::post('/checkout-frm-submit', [CheckoutController::class, 'store'])->name('checkout-frm-submit');

Route::get('/total-heat-pro/upsell1a', [Upsell1aController::class, 'index']);
Route::post('/upsell1a/store', [Upsell1aController::class, 'store'])->name('upsell1a.store');

Route::get('/total-heat-pro/upsell2', [Upsell2Controller::class, 'index']);
Route::post('/upsell2/store', [Upsell2Controller::class, 'store'])->name('upsell2.store');
Route::get('/total-heat-pro/thank-you', [ThankYouController::class, 'index'])->name('thank-you');
