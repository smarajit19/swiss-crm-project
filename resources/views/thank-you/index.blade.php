        ...
        <div class="row">
            <div class="col-lg-7 m-auto">
                <div class="blue-sec-text">
                    ...
                    <p>Your order numbers are . We will pack your order and ship it to you right away. You will receive an email confirmation shortly at . Please print this page for your records.</p>
                </div>
                ...
                <div class="white-sec">
                    ...
                    <div class="row thank_prtt">
                        <div class="thank_clr">
                            <div class="shipingAdd">
                                ...
                                <p class="shipping-name-section"></p>
                                <p class="shipping-address-section"></p>
                                <p class="shipping-citystate-section">, ,</p>
                                <p class="shipping-zip-section"></p>
                            ...
                            <div class="form-shpping">
                                <form class="update-shipping-address" id="shipping-info" name="prospect_form1">
                                    ...
                                    <div class="form-group form-label-group mb-2">
                                        <input type="text" spellcheck="false" autocorrect="off" name="shippingAddress1" id="inputAddress" class="form-control required cb-remove-class" placeholder="Address" data-error-message="Please enter your address!" value="" required>
                                    ...
                                    <div class="form-group mb-2 position-relative">
                                        <input type="text" id="inputState" name="shippingState" placeholder="Your State" class="form-control required cb-remove-class" data-error-message="Please select your state!" data-selected="" />
                                    </div>
                                    <div class="form-group mb-2 position-relative">
                                        <select id="inputCountry" name="shippingCountry" class="form-control required cb-remove-class" data-selected="" data-error-message="Please select your country!">
                                            <option value="">Select Country</option>
                                        </select>
                                    </div>
                                    <div class="form-group form-label-group mb-2">
                                        <input type="text" name="shippingZip" id="inputZip" class="form-control required cb-remove-class" placeholder="Zip" data-error-message="Please enter a valid zip code!" value="" maxlength="7" required>
                                    </div>
                    ...
                    <div class="order-sec">
                        ...
                        <br>
                        <h3>Charges on your statement will be processed for $0.00 and will appear as TACTICAL SUPPLY 8668090004.</h3>
                    </div>
                </div>
