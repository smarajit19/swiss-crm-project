        ...
        <div class="up-s1-Box">
          <div class="up-s1-lft up-s1-lft-new">
            ...
            <p class="ups1-txt2 hide-mob">
              ...
              <span style="color: #ee404c">$49.99!</span>
            </p>
            ...
            <div class="prt-upA">
              <div class="show-mob">
                ...
                <p class="ups1-txt2 hide-mob">
                  Enjoy your <br /><b style="color: #ee404c">EXCLUSIVE OFFER</b
                  ><br />
                  on the
                    ...
                    <div class="col-12">
                      <div class="right-box px-3 pe-0">
                        <p class="fs-6 fw-bold pt-0">
                          <span class="undr"
                            ><span class="d-block">1x Vital Smart Glasses</span>
                            <span class="d-block" style="color: #000"
                              >1x VIP Customer Perks</span
                            ></span
                          >
              ...
              <div class="save-strip save-strip-new up2save-strip">
                <p>
                  <small
                    style="font-weight: bold; color: #ff0f0f; font-size: 16px"
                    >Only 6 Extra Bonus Vital Smart Glasses left!</small
                  ><br />
